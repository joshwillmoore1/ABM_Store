...
class TestPressNDM: public AbstractCellBasedTestSuite
{
public:


void Test2dBilayeProliferationPressLumenForPolarisation()
    {
       ...
       // RandomNumberGenerator::Instance()->Reseed(5);
        ...
        static double ORGANOID_DOMAIN =11; //31
       ...
       cell_population.RemoveDeadCells();
        ...
        simulator.SetOutputDirectory("Test Ratios 0.5sqrt2");
