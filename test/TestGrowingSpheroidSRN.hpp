...
class TestCurvatureNDM: public AbstractCellBasedTestSuite
{
public:
    void Test2dGrowingWithLumenFormation()
    {
        ...
        static double lum_radius = 0.5*sqrt(2);
        ...
        for (unsigned i=0; i<mesh.GetNumNodes(); i++)
        {
            ...
            double birth_time = RandomNumberGenerator::Instance()->ranf()*(-20);
       ...
       {   
        ...
        simulator.SetOutputDirectory("GrowingSpheroid 2D adaptive cycles");
        simulator.SetSamplingTimestepMultiple(50);
        simulator.SetDt(0.002);
        simulator.SetEndTime(90);
        ...
        p_random_force->SetMovementParameter(0.00025); //0.1 causes dissasociation, 0.001 is not enough (growing 0.00025)
        simulator.AddForce(p_random_force);

        // The lumen formation class will set central cells to differentiated type - i.e. will not signal
        ...
        //this has been made homogeneous to investiage the SRN model
