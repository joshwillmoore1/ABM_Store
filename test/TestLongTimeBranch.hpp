...
class TestLongTimeBranch : public AbstractCellBasedTestSuite
{
    /*
...
public:
    ...
    void TestVertexBoundaryBilayersPolarised_1()
    {
        ...
        std::string TestoutputName = "No_press_force_" + std::to_string(1);
        ...
        MAKE_PTR_ARGS(BoundaryCellTypeMod<2>, p_cellTypeMod, (&cell_population));
        simulator.AddCellKiller(p_cellTypeMod);
