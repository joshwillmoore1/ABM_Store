...
class TestGrowingBilayerNotch : public AbstractCellBasedTestSuite
{
        ...
        void TestVertexBoundaryBilayersPolarised_1()
    {
        ...
        std::string TestoutputName = "Test_branch_growth" + std::to_string(1);
        ...
        // edit this depending on cell-type - luminal cells divide normally to the surface while basal cells divide along the surface 
        MAKE_PTR(BranchDivisionRule<2>, p_DivRule);
